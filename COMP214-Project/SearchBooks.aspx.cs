    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++) // Loop each row in the gridview
            {
                ...
                hyperLink.NavigateUrl = "BookDetails.aspx?id="+ GridView1.Rows[i].Cells[0].Text;
                hyperLink.Text = GridView1.Rows[i].Cells[1].Text;
                GridView1.Rows[i].Cells[1].Controls.Add(hyperLink);
            }
        }
    }
}